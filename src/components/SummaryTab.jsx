    ...
    <div className="tab-content">
      <div className="verdict-bar">
        ...
        <div className="vb-sub">
          ~₹10.5L upfront (BaaS, Exclusive — est.) · ₹3.5/km battery, no minimum
          · ~₹27K/month EMI if financed · lifetime battery warranty
        </div>
      </div>
      ...
      <div className="card car-hero-card">
        ...
        <div className="car-hero-info">
          <div>
            ...
            <div className="car-hero-spec">
              38 kWh · 136 PS · 2,700mm wheelbase · 604L boot
            </div>
          </div>
      ...
      <div className="card">
        ...
        <p className="footnote">
          *Exclusive BaaS price approx — confirm with MG dealer. Standard ₹9.99L
          is for base Windsor.
        </p>
      </div>
    </div>
